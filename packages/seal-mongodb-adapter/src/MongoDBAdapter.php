...
final class MongoDBAdapter implements AdapterInterface
{
    ...
    public function __construct(
        ...
        $this->schemaManager = $schemaManager ?? new MongoDBSchemaManager($client);
        $this->indexer = $indexer ?? new MongoDBIndexer($client);
        $this->searcher = $searcher ?? new MongoDBSearcher($client);
    }
